...
wccp2HandleUdp(int sock, void *)
{
    ...
    while (data_length > offset) {
        ...
        case WCCP2_ROUTER_ID_INFO:
            ...
            if (router_identity_info != nullptr) {
    ...
    if ((security_info == nullptr) || (service_info == nullptr) || (router_identity_info == nullptr) || (router_view_header == nullptr)) {
    ...
    if (router_list_ptr->next == nullptr) {
