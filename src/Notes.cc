...
void
Note::updateNotePairs(const NotePairs::Pointer& pairs, const CharacterSet *delimiters, const AccessLogEntryPointer &al)
{
    for (const auto& v: values) {
...
void
Notes::updateNotePairs(const NotePairs::Pointer& pairs, const CharacterSet *delimiters, const AccessLogEntry::Pointer &al)
{
