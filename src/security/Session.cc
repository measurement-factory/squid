...
bool
Security::CreateClientSession(FuturePeerContext &ctx, const Comm::ConnectionPointer &c, const Acl::ChecklistFiller &caller)
{
    ...
    return CreateSession(ctx.raw, c, ctx.options, Security::Io::BIO_TO_SERVER, caller, "establishing a TLS connection");
}
