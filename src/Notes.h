...
public:
    ...
    private:
        ...
        const SBuf &format(const AccessLogEntryPointer &al, const RecordTime &);
    ...
    void updateNotePairs(NotePairsPointer pairs, const CharacterSet *delimiters, const AccessLogEntryPointer &al, const RecordTime &);
...
public:
    ...
    void updateNotePairs(NotePairsPointer pairs, const CharacterSet *delimiters,
                         const AccessLogEntryPointer &al, const RecordTime &);
private:
