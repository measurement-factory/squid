...
ACLExternal::parse()
{
    ...
    const auto token = ConfigParser::Current().requiredAclValue("external acl name");
    ...
    for (const auto tok: ConfigParser::Current().optionalAclValues("external acl arguments"))
