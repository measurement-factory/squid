...
private:
    ...
    AccessLogEntry::Pointer ale() const { assert(fwd); assert(fwd->al); return fwd->al; }
    ...
    static bool decideIfWeDoRanges (HttpRequest *orig_request, const AccessLogEntryPointer &);
