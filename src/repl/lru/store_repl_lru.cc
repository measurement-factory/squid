...
static LruPolicyData *
DataIdle(RemovalPolicy *policy) { return reinterpret_cast<LruPolicyData *>(policy->_dataIdle); }

static LruPolicyData *
DataBusy(RemovalPolicy *policy) { return reinterpret_cast<LruPolicyData *>(policy->_dataBusy); }
