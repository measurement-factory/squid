...
public:
    ...
    /// generates a callback for future use with the event data
    /// provided and current code context
    /// TODO: return the callback to the caller
    void buildCall();
    ...
    /// a callback generated by buildCall()
