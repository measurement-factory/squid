...
AC_DEFUN([SQUID_CHECK_LIBCRYPTO_API],[
  ...
  AH_TEMPLATE(HAVE_LIBCRYPTO_ASN1_TIME_SET_STRING, "Define to 1 if the ASN1_TIME_set_string() OpenSSL API function exists")
  AH_TEMPLATE(HAVE_LIBCRYPTO_ASN1_TIME_TO_TM, "Define to 1 if the ASN1_TIME_to_tm() OpenSSL API function exists")
  ...
  AC_CHECK_LIB(crypto, ASN1_TIME_set_string, AC_DEFINE(HAVE_LIBCRYPTO_ASN1_TIME_SET_STRING, 1))
  AC_CHECK_LIB(crypto, ASN1_TIME_to_tm, AC_DEFINE(HAVE_LIBCRYPTO_ASN1_TIME_TO_TM, 1))
